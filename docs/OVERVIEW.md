...
**Storybox** is a standalone, screen-based storytelling device designed for children aged 3–8. It runs a local React application served via an Express backend in kiosk mode on a Raspberry Pi. The application emphasizes offline capability, tactile interaction, and voice-narrated stories, potentially generated by AI.
